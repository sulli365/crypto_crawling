...
def load_crypto_api_configs() -> List[CryptoApiConfig]:
    ...
    config_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(
        os.path.abspath(__file__))))), "config")
    config_path = os.path.join(config_dir, "crypto_api_configs.json")
...
def create_default_configs() -> List[CryptoApiConfig]:
    ...
    docs_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(
        os.path.abspath(__file__))))), "docs")
    markdown_path = os.path.join(docs_dir, "crypto-apis.md")
