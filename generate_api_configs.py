...
from crypto_api_config import CryptoApiConfig, save_crypto_api_configs
...
async def main():
    ...
    parser.add_argument("--output", default="crypto_api_configs.json", help="Output file for configurations")
