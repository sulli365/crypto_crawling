...
# Import our custom modules - use absolute imports to avoid issues
import sys
import os
sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from crypto_api_config import CryptoApiConfig, get_urls_from_sitemap, is_documentation_url
...
if __name__ == "__main__":
    ...
    from crypto_api_config import load_crypto_api_configs
